...
public class LTSeq
{
    ...
    /**
	* Add a _currentPlayTime delay to the sequence
	* @method append (delay)
	* @param {float} delay:float amount of _currentPlayTime to add to the sequence
	...
	*/
    ...
    private void setScaleRecursive(LTSeq seq, float timeScale, int count)
    {
        if (count > 0)
        {
            ...
            if (seq.tween != null)
            {
                //			Debug.Log("seq.tween._currentPlayTime * timeScale:" + seq.tween._currentPlayTime * timeScale + " seq.totalDelay:"+seq.totalDelay +" _currentPlayTime:"+seq.tween._currentPlayTime+" seq.tween.delay:"+seq.tween.delay);
